...
class HeartRateMonitorPage extends StatefulWidget {
  HeartRateMonitorPage({Key? key}) : super(key: key);
...
class _HeartRateMonitorPageState extends State<HeartRateMonitorPage> {
  ...
  double _calculateHeartRate(img.Image image) {
    ...
    double meanIntensity = pixelIntensities.reduce((a, b) => a + b) / pixelIntensities.length;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('Heart Rate Monitor', style: TextStyle(color: Colors.white)),
                    ...
                    children: [
                      ElevatedButton(
                        ...
                        style: ElevatedButton.styleFrom(
                          foregroundColor: Colors.white, backgroundColor: _isMonitoring ? Colors.red : Colors.green,
